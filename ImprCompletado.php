...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['return_to_pending'])) {
    ...
    try {
        // Actualizar el estado en la tabla impresion a Entregado = 0
        $sqlUpdateImpresion = "UPDATE impresion SET Entregado = 0 WHERE Id_Servicio = ?";
        ...
        header("Location: ImprCompletado.php");
        exit;
...
// Obtener pedidos de impresión completados (Entregado = 1)
// NOTA: En tu base de datos no existe el campo FechaEntrega, se usan campos separados para día, mes y año
$sqlCompletados = "SELECT s.Id_Servicio, s.nombreServicio, s.Descripcion, 
                  ...
                  i.DiaEntrega, i.MesEntrega, i.AnioEntrega
                  FROM servicio s
...
<head>
    ...
    <title>Ciber Rotsen - Impresiones Completadas</title>
...
<body>
    ...
    <div class="container">
        <div class="column" id="columnaTitulo">
            ...
            <h2 id="textoBajoh1" class="titulo">Pedidos de Impresión Completados</h2> 
        </div>
    </div>
    ...
    <div> 
        ...
        <?php else: ?>
            <div class="no-completados">
                <p>No hay pedidos de impresión completados para mostrar.</p>
            </div>
        <?php endif; ?>
    </div>
